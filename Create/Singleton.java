...
/**
 * 双重校验锁
 * 	第一个if (instance == null)是为了解决 Singleton1 中的效率问题，只有 instance 为 null 的时候，
 * 	才进入 synchronized 的代码段。
...
/**
 * 登记式单例写法
 * 	登记式单例实际上维护了一组单例类的实例，将这些实例存放在一个 Map（登记薄）中，对于已经登记过的实例，则从 Map 直接返回，
 * 	对于没有登记的，则先登记，然后返回。
 * 
 * @author Mauger
 * @date 2018年4月19日  
